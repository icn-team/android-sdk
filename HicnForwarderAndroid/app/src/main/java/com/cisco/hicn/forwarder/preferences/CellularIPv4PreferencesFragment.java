...
public class CellularIPv4PreferencesFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        getPreferenceScreen().findPreference(getString(R.string.cellular_source_port_ipv4_key)).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
        ...
        getPreferenceScreen().findPreference(getString(R.string.cellular_nexthop_ipv4_key)).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        getPreferenceScreen().findPreference(getString(R.string.cellular_nexthop_port_ipv4_key)).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object newValue) {
