...
public class WifiIPv4PreferencesFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        getPreferenceScreen().findPreference(getString(R.string.wifi_source_port_ipv4_size_key)).setEnabled(sharedPreferences.getBoolean(getString(R.string.enable_nexthop_ipv4_key), false));
        ...
        getPreferenceScreen().findPreference(getString(R.string.wifi_source_port_ipv4_size_key)).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
