...
Java_com_cisco_hicn_forwarder_supportlibrary_NativeAccess_startHiPerf(JNIEnv *env, jobject thiz,
                                                                      jstring hicn_name,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_cisco_hicn_forwarder_supportlibrary_NativeAccess_stopHiPerf(JNIEnv *env, jobject thiz) {
